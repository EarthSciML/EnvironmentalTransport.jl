...
@component function SulfurCycle(; name = :SulfurCycle)
    ...
    @parameters begin
        τ_SO2_d = 216000.0,
        [description = "SO2 dry deposition residence time (60 hr)", unit = u"s"]
        τ_SO2_w = 360000.0,
        [description = "SO2 wet deposition residence time (100 hr)", unit = u"s"]
        τ_SO2_c = 288000.0,
        [description = "SO2 chemical conversion residence time (80 hr)", unit = u"s"]
        τ_SO4_d = 1440000.0,
        [description = "SO4 dry deposition residence time (400 hr)", unit = u"s"]
        τ_SO4_w = 288000.0,
        [description = "SO4 wet deposition residence time (80 hr)", unit = u"s"]
    end
    ...
    @variables begin
        ...
        b(t),
        [description = "Fraction of S converted to SO4 before removal (dimensionless)",
            unit = u"1"]
        τ_S(t), [description = "Mean residence time of a sulfur atom", unit = u"s"]
        c(t),
        [description = "Fraction of total sulfur that is SO2 (dimensionless)", unit = u"1"]
...
@component function CarbonCycle(; name = :CarbonCycle)
    # Unit conversion: 1 Pg = 10^12 kg = 10^15 g, 1 year = 31557600 s (Julian year)
    @constants begin
        # Table 22.1 — First-order exchange coefficients (converted from yr^-1 to s^-1)
        k12 = 0.0931 / 31557600.0,
        [description = "Atmosphere to warm ocean transfer coefficient", unit = u"s^-1"]
        k13 = 0.0311 / 31557600.0,
        [description = "Atmosphere to cool ocean transfer coefficient", unit = u"s^-1"]
        k23 = 0.0781 / 31557600.0,
        [description = "Warm ocean to cool ocean transfer coefficient", unit = u"s^-1"]
        k24 = 0.0164 / 31557600.0,
        [description = "Warm ocean to deep ocean transfer coefficient", unit = u"s^-1"]
        k34 = 0.714 / 31557600.0,
        [description = "Cool ocean to deep ocean transfer coefficient", unit = u"s^-1"]
        k42 = 0.00189 / 31557600.0,
        [description = "Deep ocean to warm ocean transfer coefficient", unit = u"s^-1"]
        k43 = 0.00114 / 31557600.0,
        [description = "Deep ocean to cool ocean transfer coefficient", unit = u"s^-1"]
        k51 = 0.0862 / 31557600.0,
        [description = "Biota to atmosphere transfer coefficient", unit = u"s^-1"]
        k56 = 0.0862 / 31557600.0,
        [description = "Biota to soils/detritus transfer coefficient", unit = u"s^-1"]
        k61 = 0.0333 / 31557600.0,
        [description = "Soils/detritus to atmosphere transfer coefficient", unit = u"s^-1"]

        # Table 22.1 — Nonlinear ocean parameters (dimensionless)
        β2 = 9.4,
        [description = "Warm ocean carbonate buffer exponent (dimensionless)", unit = u"1"]
        β3 = 10.2,
        [description = "Cool ocean carbonate buffer exponent (dimensionless)", unit = u"1"]
        ...
        a_d = 0.230,
        [
            description = "Fraction of deforested area unavailable for regrowth (dimensionless)",
            unit = u"1"]
        a_r = 1.0,
        [description = "Fraction of reforested area increasing biota (dimensionless)",
            unit = u"1"]
        ...
        k15 = 147.27e12 / 31557600.0,
        [description = "Atmosphere to biota base uptake rate", unit = u"kg/s"]
        ...
        F21_pre = 58.0e12 / 31557600.0,
        [description = "Preindustrial warm ocean to atmosphere flux", unit = u"kg/s"]
        F31_pre = 18.0e12 / 31557600.0,
        [description = "Preindustrial cool ocean to atmosphere flux", unit = u"kg/s"]

        # Preindustrial reservoir masses for normalization (converted from Pg C to kg)
        M2_pre = 730.0e12,
        [description = "Preindustrial warm ocean surface carbon", unit = u"kg"]
        M3_pre = 140.0e12,
        [description = "Preindustrial cool ocean surface carbon", unit = u"kg"]

        # Preindustrial M5(0) for G equation (converted from Pg C to kg)
        M5_0 = 580.0e12,
        [description = "Preindustrial terrestrial biota carbon", unit = u"kg"]
    end
    ...
    @variables begin
        ...
        M2(t) = 730.0e12,
        [description = "Carbon in warm ocean surface waters", unit = u"kg"]
        M3(t) = 140.0e12,
        [description = "Carbon in cool ocean surface waters", unit = u"kg"]
        ...
        G(t) = 1.0,
        [
            description = "Deforestation/reforestation scaling factor (dimensionless)", unit = u"1"]
    ...
    eqs = [
        ...
        D(M1) ~
        -(k12 + k13) * M1 - F15_flux + F21_flux + F31_flux + k51 * M5 + k61 * M6 + Ff + Fd -
        Fr,
...
@component function FourCompartmentAtmosphere(; name = :FourCompartmentAtmosphere)
    @parameters begin
        ...
        [description = "NH to SH troposphere exchange rate", unit = u"s^-1"]
        k_T_SH_NH = 1.0 / 31557600.0,
        [description = "SH to NH troposphere exchange rate", unit = u"s^-1"]
        k_S_NH_SH = 0.25 / 31557600.0,
        [description = "NH to SH stratosphere exchange rate", unit = u"s^-1"]
        k_S_SH_NH = 0.25 / 31557600.0,
        [description = "SH to NH stratosphere exchange rate", unit = u"s^-1"]

        # Troposphere-stratosphere exchange rates (converted from yr^-1 to s^-1)
        k_NH_T_S = 0.063 / 31557600.0,
        [description = "NH troposphere to stratosphere exchange rate", unit = u"s^-1"]
        k_NH_S_T = 0.4 / 31557600.0,
        [description = "NH stratosphere to troposphere exchange rate", unit = u"s^-1"]
        k_SH_T_S = 0.063 / 31557600.0,
        [description = "SH troposphere to stratosphere exchange rate", unit = u"s^-1"]
        k_SH_S_T = 0.4 / 31557600.0,
        [description = "SH stratosphere to troposphere exchange rate", unit = u"s^-1"]
    ...
    eqs = [
        ...
        0 ~
        -(k_T_NH_SH + k_NH_T_S + k_T_NH) * Q_T_NH + k_T_SH_NH * Q_T_SH + k_NH_S_T * Q_S_NH +
        P_NH,

        # Eq. 22.27 — SH troposphere steady-state balance
        0 ~
        -(k_T_SH_NH + k_SH_T_S + k_T_SH) * Q_T_SH + k_T_NH_SH * Q_T_NH + k_SH_S_T * Q_S_SH +
        P_SH,

        # Eq. 22.28 — NH stratosphere steady-state balance
        0 ~
        -(k_S_NH_SH + k_NH_S_T + k_S_NH) * Q_S_NH + k_S_SH_NH * Q_S_SH + k_NH_T_S * Q_T_NH,

        # Eq. 22.29 — SH stratosphere steady-state balance
        0 ~
        -(k_S_SH_NH + k_SH_S_T + k_S_SH) * Q_S_SH + k_S_NH_SH * Q_S_NH + k_SH_T_S * Q_T_SH,
